...
var wilson = Author(firstName: "Wilson", lastName: "Rawls", living: false)

var redFern = Book(tile: "Where the Red Fern Grows", author: wilson, pages: 245, numberOfStars: 4, description: "This book is about a young boy and his hunting dogs. ", genre: "Children")
